...
{
    /// <summary>Interaction logic for EndedPage.xaml</summary>
    public partial class EndedPage
    {
        ...
        {
            _series = AppState.AllSeries.FindAll(series => series.Status == SeriesStatus.Ended).OrderBy(series => series.Name).ToList();
        ...
        private void EndedPage_OnLoaded(object sender, RoutedEventArgs e)
        {
